...
public class TransferQueueTests : IDisposable
{
    ...
    private static readonly int QueueCompletionTimeout = RuntimeInformation.IsOSPlatform(OSPlatform.OSX) ? 100000 : 5000;
    private static readonly int FileProcessingDelay = RuntimeInformation.IsOSPlatform(OSPlatform.OSX) ? 20000 : 1000;
    private static readonly int MultiFileTimeout = RuntimeInformation.IsOSPlatform(OSPlatform.OSX) ? 150000 : 10000;
    private static readonly int StopDelay = RuntimeInformation.IsOSPlatform(OSPlatform.OSX) ? 10000 : 500;
